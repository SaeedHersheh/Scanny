...
<div class="login-container">
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <button type="submit" class="sign-in-button"><b>Register</b></button>
    </form>

    <div style="margin-top:10px; text-align:center;">
        <a href="{{ route('login.form') }}" style="text-decoration:none;">Already have an account? Login</a>
    </div>
